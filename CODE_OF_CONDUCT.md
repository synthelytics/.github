...
Below is the Code of Conduct to which all contributors and participants in the [{{ cookiecutter.project_name }}](https://github.com/{{ cookiecutter.github_user }}/{{ cookiecutter.project_name }}) community are expected to adhere.
